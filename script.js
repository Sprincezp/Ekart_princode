        ...
        async function searchPincode() {
            ...
            const result = pincodeMap.get(Number(pincode));
            if (result) {
                showResult(result);
            } else {
        ...
        function showResult(data) {
            const airBranch = data.airOuCode ? data.airOuCode : 'N/A';
            const branch = data.ouCode ? data.ouCode : data.branch;
            ...
            const status = (data.activeFlag || data.status) === 'YES' || (data.status || '').toUpperCase() === 'ACTIVE' ? 'Active' : 'Inactive';
                ...
                <div class="result-card">
                    <div class="result-header">
                        <div class="result-pincode">
                            ...
                            <span class="result-branch">${branch}</span>
                        </div>
                    ...
                    <div class="result-body">
                        ...
                        <div class="service-section">
                            ...
                            <div class="service-grid">
                                <div class="service-item">
                                    ...
                                    ${renderYesNo(data.roadPickupAllowed)}
                                </div>
                                <div class="service-item">
                                    <span class="service-item-name">Delivery</span>
                                    ${renderYesNo(data.roadDeliveryAllowed)}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="service-section">
                            ...
                            <div class="service-grid">
                                <div class="service-item">
                                    <span class="service-item-name">Pickup</span>
                                    ${renderYesNo(data.airPickupAllowed)}
                                </div>
                                <div class="service-item">
                                    <span class="service-item-name">Delivery</span>
                                    ${renderYesNo(data.airDeliveryAllowed)}
                                </div>
                            </div>
                        </div>
                    </div>
